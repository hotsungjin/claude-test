    ...
    <form id="frmBoard" action="board_ps.php" method="post" enctype="multipart/form-data">
        ...
        <table class="table table-cols">
            ...
            <tr class="if-is-qa-hide">
                ...
                <td>
                    <label class="checkbox-inline">
                        <input type="checkbox" name="bdSpamMemoFl[]"
                               value="1" <?= gd_isset($checked['bdSpamMemoFl'][1]) ?> />
                        외부유입차단
                    </label>
                    <label class="checkbox-inline">
                        <input type="checkbox" name="bdSpamMemoFl[]"
                               value="2" <?= gd_isset($checked['bdSpamMemoFl'][2]) ?> />
                        자동등록방지문자
                    </label>
                    <label class="checkbox-inline">
                        <input type="checkbox" name="bdPasswordMemoFl"
                               value="y" <?= gd_isset($checked['bdPasswordMemoFl']['y']) ?> />
                        비밀댓글 암호보안
                    </label>
