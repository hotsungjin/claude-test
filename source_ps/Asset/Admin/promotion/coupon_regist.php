    ...
    <table class="table table-cols">
        ...
        <tr class="tr_down tr_auto">
            ...
            <td colspan="3" class="couponEventType">
                ...
                <dl class="dl-horizontal" id="couponSaveDuplicateNotice"></dl>
            </td>
...
<script type="text/javascript">
    ...
    function changeCouponEventType() {
        ...
        if (couponSaveType != 'auto') { // couponEventType 은 자동 발급 선택 시에만 노출
            return;
        }

        // 쿠폰 이벤트 타입에 따른 폼 변경
        const couponEventType = $('input:radio[name="couponEventType"]:checked').val();
        ...
        $('#issueMemberGroupTr').toggle(couponEventType != 'join');
