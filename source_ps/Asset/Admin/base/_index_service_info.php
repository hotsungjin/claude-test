            ...
            $.post('<?php echo URI_ADMIN;?>base/disk_space.php', {'mode': mode}, function (data) {
                ...
                if (diskData.supplyDisk == '') {
                    ...
                    if (diskData.usedPer == '100') {
                        var message = '쇼핑몰 제공용량이 초과되었습니다. <span class="c-gdred">초과 상태로 ' + diskData.diskLimitDate + '일 경과 시, 전체 관리자 로그인이 차단</span>됩니다.<br /><br />- 초과시점 : <span class="c-gdred">' + diskData.fullDate + '</span><br />- 잔여용량 확보 방법 안내<br />1. 불필요한 용량 정리<br />2. 디스크 용량 추가';
                        var btnText = {};
