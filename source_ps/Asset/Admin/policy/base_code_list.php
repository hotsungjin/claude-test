            ...
            <tr class="text-center move-row<?php if ($val['useFl'] == 'n') { ?> active<?php } ?>">
                ...
                <td>
                    <?php if ($num == 1) {
                        ...
                        $isDefaultMileageCode = $val['groupCd'] == '01005' && ($val['itemCd'] <= '01005011' || ($val['itemCd'] >= '01005501' && $val['itemCd'] <= '01005505') || $val['itemCd'] == '010059999' || $val['itemCd'] == '010059996');                        $isDefaultDepositCode = $val['groupCd'] == '01006' && ($val['itemCd'] <= '01006006' || ($val['itemCd'] >= '01006501' && $val['itemCd'] <= '01006505'));
