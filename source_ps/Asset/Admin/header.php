                ...
                <ul class="list-inline">
                    ...
                    <li class="no-bar">
                        ...
                        <span style="margin: 0; padding: 0;">
                            <a href="<?= PlusShopConfigService::getAppStoreUrl(); ?>" target="_blank" class="gnb-myshop text-red">스토어</a>
                        </span>
                    ...
                    if (gd_is_provider() === false && Session::get('manager.workPermissionFl') == 'y') {
                        echo '<li class="devide"></li><li class="admin"><a href="javascript:development_manager();" class="font">개발소스관리</a>';
                        if (!empty($inspectFileCount)){ ?>
                        ...
                        <?php }
                        echo '</li>';
                        echo '<li class="devide"></li><li class="admin"><a href="javascript:cache_manager();" class="font">속도개선관리</a></li>';
                    }
                    ?>
                    <li class="no-bar">
