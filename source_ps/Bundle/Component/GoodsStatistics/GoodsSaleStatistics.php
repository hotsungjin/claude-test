...
, SUM(totalOrderCount) AS totalOrderCount, SUM(pcOrderCount) AS pcOrderCount, SUM(mobileOrderCount) AS mobileOrderCount, regDt, modDt';
    ...
    public function listsByOrder()
    {
        ...
        $this->db->strField = "IF(gi.goodsImageStorage = 'obs', gi.imageUrl gi.imageName) as imageName, g.imageStorage, g.imagePath, og.goodsNo, og.goodsNm, og.cateCd, og.orderNo, og.orderStatus, og.taxSupplyGoodsPrice, og.taxVatGoodsPrice, og.taxFreeGoodsPrice, og.goodsCnt, o.orderTypeFl, oi.orderName, sm.companyNm";
