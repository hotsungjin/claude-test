...
{
    const KAKAO_PIXEL_MARKETING_GUIDE = 'https://marketing-help.nhn-commerce.com/godomall-ads-script/godomall-kakao-script';
    ...
    public function index()
    {
        ...
        $this->SetData('guideUrl', self::KAKAO_PIXEL_MARKETING_GUIDE);
