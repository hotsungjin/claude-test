...
{
    const TARGETING_GATES_MARKETING_GUIDE = 'https://marketing-help.nhn-commerce.com/godomall-ads-script/targetinggates';
    ...
    public function index()
    {
        ...
        $this->setData('guideUrl', self::TARGETING_GATES_MARKETING_GUIDE);
