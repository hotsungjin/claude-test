...
{
    const NAVER_SCRIPT_MARKETING_GUIDE = 'https://marketing-help.nhn-commerce.com/godomall-ads-script/wcs.trans-version';
    ...
    public function index()
    {
        ...
        $this->setData('guideUrl', self::NAVER_SCRIPT_MARKETING_GUIDE);
