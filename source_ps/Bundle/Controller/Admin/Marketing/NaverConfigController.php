...
{
    const NAVER_SHOPPING_MARKETING_GUIDE = 'https://marketing-help.nhn-commerce.com/announcement/naver-shopping/db-url-1';
    ...
    public function index()
    {
        ...
        $this->setData('guideUrl', self::NAVER_SHOPPING_MARKETING_GUIDE);
