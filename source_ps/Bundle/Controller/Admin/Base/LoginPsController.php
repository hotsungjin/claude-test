                ...
                case 'login':
                    ...
                    if ($securityPolicy->useSecurityLogin() &&
                        ...
                        if ($isValidAuth()) {
                            ...
                            if ($request->post()->has('returnUrl') && $request->post()->get('returnUrl')) {
                                ...
                                $returnUrl = $licenseRenewService->needStandardLicenseRenew() ? URI_ADMIN . 'base/index.php' : $request->post()->get('returnUrl');
                    ...
                    if ($diskData['adminAccess'] === false) {
                        if ($managerInfo['scmKind'] === 'c') {
                            $commerceMallListUrl = ManagerLoginService::getNhnCommerceMyGodoShopMainUrl();
