...
class IndexController extends \Controller\Admin\Controller
{
    ...
    public function index()
    {
        ...
        $this->setData('keywordAdUrl', GuideUrl::MARKETING_KEYWORD_AD_URL);
        $this->setData('googleAdUrl', GuideUrl::MARKETING_GOOGLE_AD_URL);
        $this->setData('facebookAdUrl', GuideUrl::MARKETING_FACEBOOK_AD_URL);
        $this->setData('retargetingAdUrl', GuideUrl::MARKETING_RETARGET_AD_URL);
