...
class BaseInfoController extends \Controller\Admin\Controller
{
    ...
    public function index()
    {
        ...
        $domainUrlList = [
            'intro' => $this->getNhnCommerceEchostUrl('/power/add/convenience/domain-intro.gd'),
            'manage' => $this->getDomainManageUrl($domainFl),
            'guide' => $this->getBeginnerDesignGuideUrl('/starter/domain'),
            'guide_mail_cert' => $this->getNhnCommerceSupportHelpUrl('/faq/etc/mail-certification/godomall'),
        ];
    ...
    private function getDomainManageUrl(string $countryCode): string
    {
        ...
        $domainManagerUrlMap = [
            'kr' => $this->getNhnCommerceMyGodoUrl("/myGodo_Domain_change.php?$domainChangeUrlParam"),
    ...
    private function getNhnCommerceEchostUrl(string $suffix = null): string
    {
        $baseUrl = \App::isProduction() ? 'https://www.nhn-commerce.com/echost' : 'https://alpha-www.nhn-commerce.com/echost';
        return $baseUrl . $suffix;
    }

    private function getBeginnerDesignGuideUrl(string $suffix = null): string
    {
        $baseUrl = 'https://godomall-help.nhn-commerce.com/biginner';
        return $baseUrl . $suffix;
    }
    ...
    private function getNhnCommerceSupportHelpUrl(string $suffix = null): string
    {
        $baseUrl = 'https://support-help.nhn-commerce.com';
        return $baseUrl . $suffix;
    }
}
